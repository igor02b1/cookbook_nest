...
**Linha 7:** Foi criado um Método Construtor, que receberá as Injeções de Dependência. Como precisaremos ter acesso aos Métodos da **Classe PostagemService**, foi injetado um Objeto desta Classe, chamado postagemService, dentro do Método Construtor.
