...
**Linha 55:** Verifica se o Objeto **buscaUsuario é nulo**, ou seja, se o Objeto da Classe Usuario não existe. Caso ele não exista, ele poderá ser persistido no Banco de dados.
