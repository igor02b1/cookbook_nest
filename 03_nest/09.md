...
1. Criar o Método findByTitulo(titulo: string) para listar um grupo de postagens específico na Classe PostagemService
1. Criar o Método findByTitulo(id: string) para executar o Método findByTitulo(id: string) da Classe PostagemService, na Classe PostagemController
