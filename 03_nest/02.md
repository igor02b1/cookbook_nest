...
| <img src="https://i.imgur.com/RfjtOFi.png" title="source: imgur.com" width="120px"/> | <div align="left">**DICA:** *Caso você precise atualizar o Nest, especialmente para corrigir problemas na instalação ou para obter novas versões do framework, utilize o comando nest update -f -t latest no terminal e aguarde a conclusão.* </div> |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
...
<div align="left"><img src="https://i.imgur.com/O6PILGE.png" title="source: imgur.com" width="25px"/> <a href="https://docs.nestjs.com/cli/usages" target="_blank"><b>Documentação: <i>Nest CLI - Scripts de execução</i></b></a>
